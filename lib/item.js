...
Item.prototype.getBike = function () {
    ...
    if (this.details.attributes) {
        this.bike = {};
        this.details.attributes.forEach(element => {
            if (element.key == "regdate") {
                this.bike.regdate = element.value;
            }
            if (element.key == "mileage") {
                this.bike.milage = element.value;
            }
            if (element.key == "cubic_capacity") {
                this.bike.cubicCapacity = element.value;
            }
        });
        if (!this.bike.regdate) {
            this.bike.regdate = '';
        }
        if (!this.bike.milage) {
            this.bike.milage = '';
        }
        if (!this.bike.cubicCapacity) {
            this.bike.cubicCapacity = '';
        }
    }
    return this;
};
